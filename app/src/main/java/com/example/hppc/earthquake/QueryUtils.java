...
public final class QueryUtils {
     ...
     * @return returns the json fetched from the usgs server.
     * */
    public static String fetchJSONArray(String stringURL){
        ...
        String jsonResponse = makeHTTPURLConnection(url);
    ...
    private static String makeHTTPURLConnection(URL url) {
        ...
        try {
            ...
            urlConnection.setReadTimeout(20000/*in milliseconds*/);
            ...
            if(urlConnection.getResponseCode()==200) {
                ...
                Log.e(LogCat,"problem url connection :" +urlConnection.getResponseCode());
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
    ...
    /**
    * @param inputStream input stream fetched from the server
    *
    * @return jsonString
    * */
    ...
    /**@param stringURL :url to the server
     * @return URL object*/
    private static URL createURL(String stringURL) {
        ...
        try {
            ...
            Log.e(LogCat,"Problem creating url",e);
        }
        return url;
    }
    ...
    public static ArrayList<EarthQuake> extractEarthquakes(String jsonResponse) {
        ...
        try {
            ...
            JSONArray features = root.getJSONArray("features");
                Log.d(LogCat,"Numbers of features in json: " + features.length());
            for(int i=0; i<features.length(); i++){
                ...
                EarthQuake earthQuakeNode = new EarthQuake(mag,location,time,url);

                earthquakes.add(earthQuakeNode);
            }
